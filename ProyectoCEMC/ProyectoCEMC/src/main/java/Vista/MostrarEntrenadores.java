...
public class MostrarEntrenadores extends javax.swing.JFrame {

    private Usuario usuario;

    // Default Constructor for IDE preview
    public MostrarEntrenadores() {
        initComponents();
    ...
    private void cargarTabla() {
        DefaultTableModel model = (DefaultTableModel) Tbl_Entrenadores.getModel();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                model.addRow(new Object[] { id, nombre, apellidos, correo, telefono, direccion, usuario1, estatus, fecha_registro, especialidad });
            }
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this, "Error al cargar entrenadores: " + ex.getMessage());
        }
    }
    ...
    private void initComponents() {
        ...
        Tbl_Entrenadores = new javax.swing.JTable();
        ...
        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 580, 50));
        ...
        Tbl_Entrenadores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Apellidos", "Correo", "Telefono", "Direccion", "Usuario", "Estatus", "Fecha reg.", "Especialidad"
            }
        ) {
        ...
        for (int i = 0; i < Tbl_Entrenadores.getColumnModel().getColumnCount(); i++) {
            Tbl_Entrenadores.getColumnModel()
            .getColumn(i)
            .setHeaderRenderer(headerRenderer);
        }
        jScrollPane1.setViewportView(Tbl_Entrenadores);

        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 870, 350));
        ...
        jPanel2.add(Lbl_Volver, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 440, 910, 30));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 910, 500));
    ...
    private javax.swing.JTable Tbl_Entrenadores;
